...
<body>
    ...
    <div class="form-group text-center">
        <div class="col-sm-10 reg-icon">
            <h2 style="text-align:center">Lista Fotografias</h2>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-12 card-margin">
                <div class="card search-form">
                    <div class="card-body p-0">
                        <form id="search-form" action="./ListarFotografias.php" method="POST">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="result-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $fotografias = Fotografia::search([], [], []);
                                                    foreach ($fotografias as $f) { ?>
                                                        <tr>
                                                            <td><?php echo $f->getId() ?></td>
                                                            <td><?php echo $f->getNome() ?></td>
                                                            <td><?php echo $f->getResolucao() ?></td>
                                                            <td><?php echo $f->getCores() ?></td>
                                                            <td><?php echo $f->getTipoFoto() ?></td>
                                                            <td><?php echo $f->getLocalizacao() ?></td>
                                                            <td><?php echo $f->getIdFotografo() ?></td>
                                                        <?php }
                                                        ?>
                                                          <td>
                                                                <a href="../Deletar/apagar_fotografia.php?id=<?php echo $f->getId() ?>"
                                                                class="btn btn-danger">Apagar Fotografia</a>
                                                            </td>
                                                        </tr>
                                                </tbody>
                                            </table>
