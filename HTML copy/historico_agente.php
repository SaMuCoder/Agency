...
require_once('../historico_agente.php');
?>
    ...
    <div class="container bootstrap snippets bootdey">
        <div class="header">
            <ul class="nav nav-pills pull-right">
                <li><a href="historico_modelo.php">Historico Modelo</a></li>
                <li class="active"><a href="historico_agente.php">Historico Agente</a></li>
        ...
        <div class="jumbotron text-center" style="min-height: 750px; height: auto">
            <div class="col-md-10 col-md-offset-2">
                <form class="form-horizontal" role="form" method="post" action="../historico_agente.php">
                    <div class="form-group text-center">
                        <div class="col-sm-10 reg-icon">
                            <span class="fa fa-user fa-3x"> Historico Agente</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">Data Fim
                            <input type="date" class="form-control" name="dataFimAgente" id="dataFimAgente" placeholder="Data Fim">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="motivoAgente" id="motivoAgente" placeholder="Motivo de saida" />
                        </div>
                    </div>
                    <div class=" form-group">
                        <div class="col-sm-10">
